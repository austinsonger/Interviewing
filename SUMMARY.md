  ...
  * [AWS](security-skills-and-technical-aptitude/cloud/aws/README.md)
    * [Security](security-skills-and-technical-aptitude/cloud/aws/security.md)
      * [General](security-domains-and-technical-aptitude/cloud-security/aws/security/general/README.md)
        ...
        * [How does AWS ensure the security of its data centers?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/how-does-aws-ensure-the-security-of-its-data-centers.md)
        * [Can you explain the concept of least privilege and how it applies to AWS?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/can-you-explain-the-concept-of-least-privilege-and-how-it-applies-to-aws.md)
        ...
        * [Can you describe the different types of AWS Identity and Access Management (IAM) policies?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/can-you-describe-the-different-types-of-aws-identity-and-access-management-iam-policies.md)
        * [How does AWS Secure Sockets Layer (SSL) and Transport Layer Security (TLS) work?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/how-does-aws-secure-sockets-layer-ssl-and-transport-layer-security-tls-work.md)
        * [Can you explain the concept of AWS Security Groups and how they can be used to control inbound and o](security-domains-and-technical-aptitude/cloud-security/aws/security/general/can-you-explain-the-concept-of-aws-security-groups-and-how-they-can-be-used-to-control-inbound-and-o.md)
        ...
        * [How does AWS enable secure access to resources using IAM roles and temporary credentials?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/how-does-aws-enable-secure-access-to-resources-using-iam-roles-and-temporary-credentials.md)
        ...
        * [Can you describe the security features of AWS Shield and how it can be used to protect against DDoS](security-domains-and-technical-aptitude/cloud-security/aws/security/general/can-you-describe-the-security-features-of-aws-shield-and-how-it-can-be-used-to-protect-against-ddos.md)
        * [How does AWS enable secure communication between services using VPC endpoints and AWS PrivateLink?](security-domains-and-technical-aptitude/cloud-security/aws/security/general/how-does-aws-enable-secure-communication-between-services-using-vpc-endpoints-and-aws-privatelink.md)
      ...
      * [Securing](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/README.md)
        ...
        * [How can you secure access to an AWS database?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-can-you-secure-access-to-an-aws-database.md)
        * [How can you secure an application running on an EC2 instance?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-can-you-secure-an-application-running-on-an-ec2-instance.md)
        * [How do you protect against security breaches on AWS?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-protect-against-security-breaches-on-aws.md)
        * [What steps do you take to ensure the security of user data stored in AWS?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/what-steps-do-you-take-to-ensure-the-security-of-user-data-stored-in-aws.md)
        * [How do you secure access to the AWS management console?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-secure-access-to-the-aws-management-console.md)
        * [How do you secure data stored in the AWS with encryption?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-secure-data-stored-in-the-aws-with-encryption.md)
        * [What steps do you take to secure your AWS infrastructure from unauthorized access?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/what-steps-do-you-take-to-secure-your-aws-infrastructure-from-unauthorized-access.md)
        * [How do you secure data in transit and at rest in AWS?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-secure-data-in-transit-and-at-rest-in-aws.md)
        * [How do you secure access to your Amazon Elastic Container Service (ECS) clusters?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-secure-access-to-your-amazon-elastic-container-service-ecs-clusters.md)
        * [How do you use Amazon Virtual Private Cloud (VPC) to secure your resources?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-use-amazon-virtual-private-cloud-vpc-to-secure-your-resources.md)
        * [How do you use AWS WAF to protect against web-based attacks?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-use-aws-waf-to-protect-against-web-based-attacks.md)
        * [How do you use AWS Certificate Manager (ACM) to secure your website and applications?](security-domains-and-technical-aptitude/cloud-security/aws/security/securing/how-do-you-use-aws-certificate-manager-acm-to-secure-your-website-and-applications.md)
